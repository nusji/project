@extends('layouts.app')
@section('title', 'จัดการประเภทเมนู')
@section('content')
    <div class="container mx-auto px-4 py-0">
        <x-breadcrumb :paths="[
            ['label' => 'ระบบเมนูข้าวแกง', 'url' => route('menus.index')],
            ['label' => 'ประเภทเมนูข้าวแกง', 'url' => route('menu_types.index')],
            ['label' => 'เพิ่ม'],
        ]" />
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <!-- ส่วนของตาราง-->
            <div class="p-6">
                <form action="{{ route('menu_types.store') }}" method="POST" class="px-4 py-5 sm:p-6">
                    @csrf
                    <div class="space-y-6">
                        <div>
