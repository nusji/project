                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex">
                            <input type="text" name="ingredient_unit"
                                placeholder="กรอกหน่วย เช่น กรัม ( หรือเลือกจากด้านขวา )"
                            ...
                            <select name="unit_suggestion"
                                class="ml-5 block w-1/3 mt-1 px-4 py-2 border rounded-md  bg-gray-100 text-gray-700 focus:outline-none focus:ring-indigo-500"
