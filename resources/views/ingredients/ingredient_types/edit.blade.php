...
@section('content')
    ...
    <!-- ส่วนของตาราง-->
    <div class="p-6">
        <form action="{{ route('ingredient_types.update', $ingredientType->id) }}" method="POST" class="px-4 py-5 sm:p-6">
            @csrf
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="text" name="ingredient_type_name" id="ingredient_type_name"
                            value="{{ old('ingredient_type_name', $ingredientType->ingredient_type_name) }}" required
