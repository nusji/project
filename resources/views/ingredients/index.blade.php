    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="p-6 bg-[#ffe070] border-b border-gray-200">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">จัดการวัตถุดิบ</h2>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    หน่วยวัตถุดิบ</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-bold text-blue-500 uppercase tracking-wider">
                                    จำนวนคงเหลือ</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 text-center uppercase tracking-wider">
                                    การจัดการ
                                </th>
                            </tr>
                        </thead>
                            ...
                            @foreach ($ingredients as $ingredient)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm  text-blue-500">
                                        <span
                                            id="quantity-{{ $ingredient->id }}">{{ $ingredient->ingredient_quantity }}</span>
                                    </td>
