...
<body class="bg-[#f5f5f5]">
    ...
    <nav class="bg-[#FFFFFF] shadow-sm fixed w-full z-20 top-0 left-0">
        <div class="container mx-auto flex justify-between items-center p-2">
            ...
            <div class="hidden md:flex items-center space-x-6">
                <!-- Display user name -->
                <span class="text-[#000000]">สวัสดีคุณ {{ Auth::user()->first_name }} (ID: {{ Auth::user()->id }})</span>
        ...
        <div class="flex flex-col p-4 space-y-2">
            ...
            <a href="{{route('employees.index')}}"
                ...
                <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 14.5c-1.933 0-3.5-1.567-3.5-3.5S10.067 7.5 12 7.5 15.5 9.067 15.5 11 13.933 14.5 12 14.5zm0-1.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM21 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2h18zM2 21v-2a6 6 0 0 1 6-6h12a6 6 0 0 1 6 6v2"></path>
                </svg>
                ข้อมูลพนักงาน
            </a>
        </div>
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="fixed inset-0 bg-white z-20 transform -translate-x-full transition-transform duration-500 ease-in-out">
