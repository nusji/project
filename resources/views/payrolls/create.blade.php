...
<div class="container mx-auto px-4 py-0">
    ...
    <h2 class="text-2xl font-bold text-gray-800 mb-4">เพิ่มรายการจ่ายเงินเดือน</h2>
        ...
        <form action="{{ route('payrolls.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="payment_date" id="payment_date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ now()->format('Y-m-d') }}" required>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="bonus" id="bonus" class="w-full px-3 py-2 bg-green-100 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" step="0.01" min="0" value="0">
                </div>
                <div>
                    <label for="salary" class="block text-sm font-medium text-gray-700 mb-2">ฐานเงินเดือน</label>
                    <input type="number" name="salary" id="salary" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" step="0.01" min="0" value="0" readonly>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="deductions" class="block text-sm font-medium text-gray-700 mb-2">หักเงิน</label>
                    <input type="number" name="deductions" id="deductions" class="w-full px-3 py-2 bg-red-100 border border-red-300  rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" step="0.01" min="0" value="0">
                </div>
                <div>
                    <label for="net_salary" class="block text-sm font-medium text-gray-700 mb-2">เงินเดือนสุทธิ</label>
                    <input type="number" name="net_salary" id="net_salary" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" step="0.01" min="0" value="0" readonly>
                </div>
            </div>
