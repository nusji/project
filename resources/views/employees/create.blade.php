        ...
        <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white border border-gray-300 shadow-lg rounded-lg p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        <label for="id_card_number" class="block text-sm font-medium text-gray-700">เลขบัตรประชาชน</label>
                    ...
                    <div class="form-group">
                        <label for="username" class="block text-sm font-medium text-gray-700">ชื่อเข้าใช้ / username</label>
                    ...
                    <div class="form-group">
                        <label for="employment_status" class="block text-sm font-medium text-gray-700">ประเภทพนักงาน</label>
                        <select id="employment_status" name="employment_status"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                            required>
                            <option value="พนักงานประจำ" {{ old('employment_status') == 'permanent' ? 'selected' : '' }}>
                                พนักงานประจำ</option>
