...
<div class="container mx-auto px-4 py-8">
    ...
    <p class="text-sm font-semi text-gray-500 mb-6">**หมายเหตุ เป็นการเพิ่มข้อมูลเบื้องต้นเพื่อเข้าใช้ระบบ พนักงานต้องกรอกข้อมูลเพิ่มเติมหลังจากล็อคอินครั้งแรก</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select id="employment_type" name="employment_type"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required>
                            <option value="พนักงานประจำ(แผนกครัว)" {{ old('employment_type') == 'พนักงานประจำ (แผนกครัว)' ? 'selected' : '' }}>
                                แผนกครัว (พนักงานประจำ)
                            </option>
                            <option value="พนักงานประจำ(แผนกขาย)" {{ old('employment_type') == 'พนักงานประจำ (แผนกขาย)' ? 'selected' : '' }}>
                                แผนกขาย (พนักงานประจำ)
                            </option>
                            <option value="พนักงานชั่วคราว" {{ old('employment_type') == 'พนักงานชั่วคราว' ? 'selected' : '' }}>
                                พนักงานชั่วคราว
                            </option>
                        </select>
                    ...
                    <div class="space-y-2">
                        <label for="password" class="text-sm font-medium text-gray-700">รหัสผ่านเข้าใช้ / password</label>
